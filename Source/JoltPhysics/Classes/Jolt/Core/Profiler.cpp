...
//@ BASTIEN ADD
ProfileStartMeasurementFunction ProfileStartMeasurement = [](const char * Event, uint32, uint8 *) { TRACE_CPUPROFILER_EVENT_MANUAL_START(Event) };
ProfileEndMeasurementFunction ProfileEndMeasurement = [](uint8 *) { TRACE_CPUPROFILER_EVENT_MANUAL_END() };
//@ BASTIEN END
