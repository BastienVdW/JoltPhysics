...
public:
	...
	/// @param inSystem Physics system that this character will be added to
										...
										CharacterVirtual(const CharacterVirtualSettings *inSettings, RVec3Arg inPosition, QuatArg inRotation, uint64 inUserData, PhysicsSystem *inSystem, BodyID* inBodyID);
										//@ BASTIEN END
										...
										CharacterVirtual(const CharacterVirtualSettings *inSettings, RVec3Arg inPosition, QuatArg inRotation, PhysicsSystem *inSystem, BodyID* inBodyID) : CharacterVirtual(inSettings, inPosition, inRotation, 0, inSystem, inBodyID) { }
										//@ BASTIEN END
	...
	//@ BASTIEN ADD
	bool								SetShape(const Shape *inShape, float inOffset, float inMaxPenetrationDepth, const BroadPhaseLayerFilter &inBroadPhaseLayerFilter, const ObjectLayerFilter &inObjectLayerFilter, const BodyFilter &inBodyFilter, const ShapeFilter &inShapeFilter, TempAllocator &inAllocator);
